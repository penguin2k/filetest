...
public class SM4Util {
    ...
    public static void encryptFile(String secretKey,String sourceFilePath, String destinationFilePath) throws NoSuchPaddingException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException {
        SecretKey sm4Key= new SecretKeySpec(secretKey.getBytes(), ALGORITHM);
        byte[] keydata=sm4Key.getEncoded();
    ...
    public static void decryptFile(String secretKey,String sourceFilePath, String destinationFilePath) throws NoSuchPaddingException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException {
        SecretKey sm4Key= new SecretKeySpec(secretKey.getBytes(), ALGORITHM);
        Cipher cipher = Cipher.getInstance("SM4/ECB/PKCS5Padding", BouncyCastleProvider.PROVIDER_NAME);
